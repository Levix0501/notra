				...
				>
					{isLangSupported(element.lang) && (
						<Button
							...
							size="icon"
							title={t.code_block_node_format_code}
							variant="ghost"
		...
		<Popover open={open} onOpenChange={setOpen}>
			...
			>
				<Command shouldFilter={false}>
					<CommandInput
						className="h-9"
						placeholder={t.code_block_node_search_language}
						value={searchValue}
						onValueChange={(value) => setSearchValue(value)}
					/>
					<CommandEmpty>{t.code_block_node_no_language_found}</CommandEmpty>
...
>) {
	...
	return (
		<Button
			...
			{...props}
		>
			<span className="sr-only">{t.code_block_node_copy}</span>
			{hasCopied ? (
...
const languages: { label: string; value: string }[] = [
	{ label: t.code_block_node_auto, value: 'auto' },
	{ label: t.code_block_node_plain_text, value: 'plaintext' },
