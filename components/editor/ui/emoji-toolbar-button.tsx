		...
		<EmojiPopover
			control={
				<ToolbarButton
					isDropdown
					pressed={isOpen}
					tooltip={t.emoji_toolbar_button_emoji}
					{...props}
				>
					<SmileIcon />
				</ToolbarButton>
...
function EmojiPickerSearchAndClear({
	...
	i18n,
	searchValue
}: Readonly<Pick<UseEmojiPickerType, 'clearSearch' | 'i18n' | 'searchValue'>>) {
	return (
...
function EmojiPreview({ emoji }: Readonly<Pick<UseEmojiPickerType, 'emoji'>>) {
	return (
...
function NoEmoji({ i18n }: Readonly<Pick<UseEmojiPickerType, 'i18n'>>) {
	return (
		<div className="flex h-14 max-h-14 min-h-14 items-center border-t border-muted p-2">
...
function PickAnEmoji({ i18n }: Readonly<Pick<UseEmojiPickerType, 'i18n'>>) {
	return (
		<div className="flex h-14 max-h-14 min-h-14 items-center border-t border-muted p-2">
