...
import { DEFAULT_SITE_LOGO, DEFAULT_SITE_TITLE } from '@/constants/default';

export default function Home() {
	return (
		<>
			<header className="sticky top-0 z-100 h-14 px-6 backdrop-blur-[5px] backdrop-saturate-[180%]">
